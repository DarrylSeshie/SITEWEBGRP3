<?php
require_once 'models/User2.class.php';
...
require_once 'managers/User2Manager.php';
require_once 'jwt_utils.php';
// Assurez-vous que le nom du fichier correspond au nom de classe UserManager

$dbManager = new DBManager();
$connexion = $dbManager->connect();
$userManager = new User2Manager($connexion); // Utilisez le bon nom de classe pour le gestionnaire d'utilisateurs
...
if ($http_method === "GET") {
    ...
    try {
        $userManager->updateUser($user); // Utilisez la méthode updateUser pour mettre à jour l'utilisateur
